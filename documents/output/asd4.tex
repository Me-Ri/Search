...
: реализовать метод наискорейшего градиентного спуска для нахождения точки глобального минимума функции Бута.% Шрифт-Times New Roman Размер шрифта-14.0 Межстрочный интервал-1.5 Правило-ONE_POINT_FIVE (1) %
%
\end{flushleft}%
\begin{center}%
